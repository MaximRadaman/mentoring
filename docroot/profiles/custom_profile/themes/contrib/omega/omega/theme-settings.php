...
function omega_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  // Add some custom_bootstrap styling and functionality to our theme settings form.
  ...
  // We need a custom_bootstrap form submit handler for processing some of the values.
